...
public class O extends Activity {
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(O.this, Alphabets_numbers.class));
        finish();
