...
public class Number9 extends Activity {
    TextView msg;
    DrawingView dv ;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Number9.this, Alphabets_numbers.class));
        finish();
