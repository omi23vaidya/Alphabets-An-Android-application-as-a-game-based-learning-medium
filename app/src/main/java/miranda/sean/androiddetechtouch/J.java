...
public class J extends Activity {
    ...
    public class DrawingView extends View {
        ...
        int flag[][] = new int[5][2];

        float boxes[][] = new float[5][4];
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(J.this, Alphabets_numbers.class));
        finish();
